"""
Django settings for nusa_lapor_backend project.
...
WSGI_APPLICATION = 'nusa_lapor_backend.wsgi.application'
ASGI_APPLICATION = "nusa_lapor_backend.asgi.application"
